...
The biospring binary should launch directly on macOS, so you can move on to the next step. For linux, please refer to part 3. of this readme for installing dependencies.
